...
class Block {
    ...
    validate() {
        ...
        return new Promise((resolve) => {
            ...
            if (currentBlockHash !== self.hash) {
                ...
                // this means that the block has NOT been tampered with
                resolve(true);
            }
     ...
     *  Steps:
     *  
     *  1. Use  module to decode the data
    ...
    getBData() {
        ...
        return new Promise((resolve, reject) => {
            const decodedDataStringified = hex2ascii(self.body);
            const decodedDataObject = JSON.parse(decodedDataStringified);
            if (self.height > 0) {
